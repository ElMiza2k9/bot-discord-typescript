...
export class Player {
	...
	public vaporwave: boolean = false
	public bassboost: boolean = false
	public distortion: boolean = false
	public eightd: boolean = false
	public karaoke: boolean = false
	...
	public setEightD(eightdd: boolean) {
	...
	public setKaraoke(karaok: boolean) {
	...
	public setTremolo(trem: boolean) {
	...
	public setDistortion(distortion: boolean) {
	...
	public setDistort(value: number) {
	...
	public setTimescale(speed?: number, pitch?: number, rate?: number) {
